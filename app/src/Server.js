...
app.get(['/createroom'], (req, res) => {
    res.sendFile(path.join(__dirname, '../../', 'public/view/createroom.html'));
});
...
app.get(['/poll'], (req, res) => {
    res.sendFile(path.join(__dirname, '../../', 'public/view/poll.html'));
});
app.get(['/wordcloud'], (req, res) => {
    res.sendFile(path.join(__dirname, '../../', 'public/view/wordcloud.html'));
});
